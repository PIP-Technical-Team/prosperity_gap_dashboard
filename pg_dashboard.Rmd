...
selectInput(
  ...
  label    = "Show regions or countries", 
  choices  = c(
    "Regions", 
    "Countries"
  ), 
...
# Select Indicator
conditionalPanel(
  condition = "input.table_region_or_country == 'Regions'", 
  checkboxGroupInput("ineq_indicator_table_region", 
            label = "Indicators:",
            choices = c(
              "Prosperity Gap",
              "Mean", 
...
conditionalPanel(
  ...
  checkboxGroupInput("ineq_indicator_table_country", 
            label = "Indicators:",
            choices = c(
              "Prosperity Gap",
              "Mean", 
...
# ineq_indicators
...
} else if(input$table_region_or_country == "Regions"){
  ...
  # Check Inputs ----
  stopifnot(is.data.table(dt))
  stopifnot(country_name_vec %chin% countries_lookup$Region_name)
  years_selected <- match.arg(years_selected)
...
table <-
  reactive({
    ...
    ct <- countries_lookup$Region_name
