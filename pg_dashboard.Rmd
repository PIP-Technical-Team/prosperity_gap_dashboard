    ...
    dt_trend_plot2[
      ...
      text_tooltip := (
        paste0(
          "Economy: "                     , Economy, "\n",
          "Year: "                        , Year,
          "\n"                            , input$indicator_trend2_regionalaggregates, ": ", round(IndicatorTrend2, 2)
        )
      )
    ]
    ...
    dt_trend_plot2[
      ...
      text_tooltip := (
        paste0(
          "Economy: "                     , Economy, "\n",
          "Year: "                        , Year,
          "\n"                            , input$indicator_trend2_economies, ": ", round(IndicatorTrend2, 2)
        )
      )
    ]
    ...
    dt_trend_plot2[
      ...
      text_tooltip := (
        paste0(
          "Economy: "                     , Economy, "\n",
          "Year: "                        , Year,
          "\n"                            , input$indicator_trend2_both, ": ", round(IndicatorTrend2, 2)
        )
      )
    ]
...
hchart(
  ...
  hc_xAxis(categories = list("Europe & Central Asia", "Latin America & Caribbean","Middle East & North Africa", "Other High Income Countries","South Asia", "Sub-Saharan Africa", "East Asia & Pacific" )) |>
