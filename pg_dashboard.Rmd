...
dt_region <- dt_region[, .(Region_code, Year, PG, PG_decomp, Inequality, Region_name)]
setorder(
  dt_region, Year
)
...
tp1 <- layout(tp1,
            title = list(
              text = paste("Figure 1:", title_function2(input$indicator_trend1_both), "over time"),
              titlefont = list(
                size = 14
              )
              ),
            ...
            yaxis = list(
              title = title_function2(input$indicator_trend1_both),
...
tp2 <- layout(tp2,
            title = list(
              text = paste("Figure 2:", title_function2(input$indicator_trend2_both), "over time"),
              titlefont = list(
                size = 14
              )
              ),
            ...
            yaxis = list(
              title = title_function2(input$indicator_trend2_both),
              titlefont = list(size  = 12)
            )
)
...
hchart(
  ...
  hc_yAxis(title = list(text = title_function2(input$indicator_barchart)), gridLineWidth =0) |>
  ...
  hc_title(text = paste0("Decomposition of ", title_function2(input$indicator_barchart), " by region")) |> 
