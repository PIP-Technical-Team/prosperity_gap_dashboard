...
tp1 <- tp1 |> layout(xaxis = list(title = ''), yaxis = list(title = paste(title_function2(ind_name1)), titlefont = list(size  = 12)))
tp2 <- tp2 |> layout(xaxis = list(title = ''), yaxis = list(title = paste(title_function2(ind_name2)), titlefont = list(size  = 12)))
...
table <-
  reactive({
    ...
    if("PG" %chin% input$ineq_indicator_table){
      setnames(
        table, 
        old = "PG", 
        new = "Prosperity Gap"
